  ...
  for (const [t3, s2] of Object.entries(e2))
    if ("children" === t3)
      for (const [t4, s3] of Object.entries(e2))
        "string" == typeof s3 ? i2.appendChild(document.createTextNode(s3)) : i2.appendChild(n(t4, s3));
    else
...
var h = class _h extends e {
      ...
      const l2 = (l3) => {
        ...
        const p = Date.now(), m = (n3) => {
          ...
          if (u2 || Math.abs(l4) > s2 || Math.abs(m2) > s2) {
            ...
            u2 || (null == i2 || i2(d2 - s3, c2 - o3), u2 = true), e2(l4, m2, r3 - s3, h3 - o3), d2 = r3, c2 = h3;
          }
        }, f = (e3) => {
          if (u2) {
  ...
  getHeight(t2, e2) {
    ...
    if ("auto" === t2) {
      ...
      return (null == e2 ? void 0 : e2.every((t4) => !t4.overlay)) ? t3 / n2 : t3;
    }
    return 128;
  }
  initHtml() {
  ...
  destroy() {
    var t2;
    this.subscriptions.forEach((t3) => t3()), this.container.remove(), null === (t2 = this.resizeObserver) || void 0 === t2 || t2.disconnect();
  }
  createDelay(t2 = 10) {
    let e2, i2;
    const n2 = () => {
  ...
  renderBarWaveform(t2, e2, i2, n2) {
    ...
    for (let t3 = 0; t3 <= o2; t3++) {
      ...
      if (o3 > g) {
        ...
        let r3 = l2 - t4;
        "top" === e2.barAlign ? r3 = 0 : "bottom" === e2.barAlign && (r3 = h2 - s3), i2[f](g * (c2 + u2), r3, c2, s3, p), g = o3, v = 0, b = 0;
      }
  ...
  renderLineWaveform(t2, e2, i2, n2) {
    const s2 = (e3) => {
      ...
      for (let t3 = 0; t3 <= r2; t3++) {
        ...
        if (r3 > l2) {
          const t4 = a2 + (Math.round(d2 * a2 * n2) || 1) * (0 === e3 ? -1 : 1);
  ...
  renderMultiCanvas(e2, i2, n2, s2, r2, o2) {
    return t(this, void 0, void 0, function* () {
      ...
      let d2 = Math.min(_h.MAX_CANVAS_WIDTH, this.scrollContainer.clientWidth);
      ...
      try {
        if (this.options.splitChannels)
          yield Promise.all(Array.from({ length: e2.numberOfChannels }).map((t3, i3) => {
            var n3;
            const s3 = Object.assign(Object.assign({}, this.options), null === (n3 = this.options.splitChannels) || void 0 === n3 ? void 0 : n3[i3]);
...
var d = class extends e {
  ...
  stopAt(t2) {
    ...
    null === (e2 = this.bufferNode) || void 0 === e2 || e2.stop(this.audioContext.currentTime + n2), null === (i2 = this.bufferNode) || void 0 === i2 || i2.addEventListener("ended", () => {
