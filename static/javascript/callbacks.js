...
let sample_audio_path = null;

// UI-related variables
const page_title = "English Pronunciation Assessment";
...
let AILanguage = "en"; // Default is English
// let index = 0;
...
const playAudio = async () => {
    ...
    document.getElementById("main_title").innerHTML = "Playing sound...";
